...
<script type="text/javascript">
	$(function(){
		...
		$('#btn').click(function(){
			$.ajax({
				url:"${pageContext.request.contextPath}/queryRoomPayInfo",
				type:"post",
...
<body>
		...
		<table id="tt">
			...
			<tr><td>入住日期:</td><td><input type="text" id="startDate" name="startDate" readonly="readonly" ></td></tr>
			<tr><td>结束日期：</td><td><input type="text" id="endDate" name="endDate" readonly="readonly" ></td></tr>
			<tr><td>房间编号:</td><td><input type="text" id="roomId" name="roomId" readonly="readonly" ></td></tr>
