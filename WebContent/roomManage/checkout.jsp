...
$(function(){
   ...
   $("#grid").datagrid({
       ...
       columns : [[ // 二维数组 支持 多级表头， 每一个数组 就是表头一行
           ...
           {
               field: "stayId", // 用于和服务器返回json中字段对应 
               title: "入住编号", // 列标题显示内容， <th> 
               width: 100
           },
           {
           ...
           {
               field: "checkDate", // 用于和服务器返回json中字段对应 
               title: "登记日期", // 列标题显示内容， <th> 
               width: 100
           },
           {
               field: "outDate", // 用于和服务器返回json中字段对应 
               title: "退房日期", // 列标题显示内容， <th> 
               width: 100
           },
           {
               field: "idCard", // 用于和服务器返回json中字段对应 
               title: "身份证号", // 列标题显示内容， <th> 
               width: 100
           },
           {
               field: "opreationer", // 用于和服务器返回json中字段对应 
               title: "操作人员", // 列标题显示内容， <th> 
               width: 100
           },
           {
           ...
           field:'xxx',title:'操作',width:100,algin:'center',formatter:function(value,row,index){
       		var id=row.id;
       		return "<a class='easyui-linkbutton' href='javascript:del("+id+")'>点击退房</a>";
       	} 
           }
       ]],
      // 加载json数据，显示表格数据 
...
<div class="place">
    ...
    <div class="formtitle"><span>退房手续</span></div>
    	<!--数据表格-->
         <table id="grid"></table>
     </div>
