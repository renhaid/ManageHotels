...
<script type="text/javascript">
	$(function(){
		...
		$('#btn').click(function(){
			$.ajax({
				url:"${pageContext.request.contextPath}/queryGaraPayInfo",
				type:"post",
...
<body>
		...
		<table id="tt">
			<tr><td>顾客姓名：</td><td><input type="text" id="custName" name="custName" readonly="readonly"  ></td></tr>
			<tr><td>登记日期:</td><td><input type="text" id="startDate" name="startDate" readonly="readonly" ></td></tr>
			<tr><td>结束日期：</td><td><input type="text" id="endDate" name="endDate" readonly="readonly" ></td></tr>
			<tr><td>车位编号:</td><td><input type="text" id="garaId" name="garaId" readonly="readonly" ></td></tr>
